...
The Hollo project has the following rules for AI usage:
...
These rules apply only to outside contributions to Hollo.  Maintainers are
...
Please remember that Hollo is maintained by humans.
...
Hollo is written with plenty of AI assistance, and many maintainers embrace
